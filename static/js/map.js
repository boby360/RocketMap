...
function gymLabel(gym, includeMembers = true) {
    ...
    if ((isUpcomingRaid || isRaidStarted) && isRaidFilterOn && isGymSatisfiesRaidMinMaxFilter(raid)) {
        ...
        if (isRaidStarted) {
            ...
            image = `<img class='gym sprite' src='gym_img?team=${gymTypes[gym.team_id]}&level=${getGymLevel(gym)}&raidlevel=${raid.level}'>`
        }
        ...
        image = `<img class='gym sprite' src='gym_img?team=${teamName}&level=${getGymLevel(gym)}'>`
    }
